(************************************************
  For x of type ¬Int (ie, Any\Int) the system
  realizes that if snd (f x) is of type Int, then
  fst (f x) must  be of type  ¬Int. The case for
  x of type Int is straightforward.
 ************************************************)
